	...
	return (
		<Grid container direction="column">
				...
				<Grid container direction="row" className={classes.serviceContainer} style={{ marginTop: matchesSM ? '1em' : '5em' }} justify={matchesSM ? 'center' : 'flex-end'}>
					<Grid item style={{ textAlign: matchesSM ? 'center' : undefined, width: matchesSM ? undefined : '35em' }}>
						...
						<Typography variant="subtitle1">
							Integrate your wrb experience or create a standalone app
			...
			<Grid item>
				...
				<Grid container direction="row" className={classes.serviceContainer} justify={matchesSM ? 'center' : undefined}>
					<Grid item style={{ marginLeft: matchesSM ? 0 : '5em', textAlign: matchesSM ? 'center' : undefined, width: matchesSM ? undefined : '35em' }}>
						...
						<Typography variant="subtitle1">
							Complete digital solutions, from investigation typography{" "}
							<span className={classes.specialtext}> celebration</span>
						</Typography>
						<Button onClick={() => { props.setValue(1); props.setSelectedIndex(1) }} variant="outlined" component={Link} to='/customsoftware' className={classes.learnButton}>
							<span style={{ marginRight: 10 }}>	Learn More </span>
							<ButtonArrow width={10} height={10} fill={theme.palette.common.blue} />
						</Button>
					</Grid>
			...
			<Grid item>
				{" "}
				{/*-----Website Block----*/}
				<Grid container direction="row" className={classes.serviceContainer} style={{ marginBottom: '10em' }} justify={matchesSM ? 'center' : 'flex-end'}>
