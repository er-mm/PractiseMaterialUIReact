...
import footerAdornmant from '../../assets/Footer Adornment.svg';
...
export default function Footer(props) {
	...
	return <footer className={classes.footer}>
		...
		<Grid container justify="center" className={classes.mainContainer}>
			...
			<Grid item className={classes.gridItem}>
				<Grid container direction='column' spacing={2}>
					...
					<Grid item className={classes.link} component={Link} onClick={()=> {props.setValue(1); props.setSelectedIndex(1)}} to='/customsoftware'>Custom Software Development</Grid>
					<Grid item className={classes.link} component={Link} onClick={()=> {props.setValue(1); props.setSelectedIndex(2)}} to='/mobileapps'>iOS/ Android App Development</Grid>
		...
		<img alt="black decorative slash" src={footerAdornmant} className={classes.adornment}/>
